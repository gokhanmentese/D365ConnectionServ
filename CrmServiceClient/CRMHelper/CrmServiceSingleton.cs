    ...
    public class CrmServiceSingleton : IDisposable
    {
        ...
        private static IOrganizationService GetCrmServiceAppUser()
        {
            try
            {
                ...
                var organizationService = crmConn.OrganizationWebProxyClient != null ? crmConn.OrganizationWebProxyClient : (IOrganizationService)crmConn.OrganizationServiceProxy;
